...
!((a) => {
   ...
   : d
    ...
    function A(a, b, c) {
        ...
        if (("number" == typeof b && (b = [b]), "[object Array]" !== Object.prototype.toString.call(b)))
            ...
            if (((d = "min" === a ? 0 : "max" === a ? 100 : Number.parseFloat(a)), !g(d) || !g(b[0])))
   ...
   for (d in a) a.hasOwnProperty(d) && e.push([a[d], d])
       for (
           e.sort(e.length && "object" == typeof e[0][0] ? (a, b) => a[0][0] - b[0][0] : (a, b) => a[0] - b[0]), d = 0;
        d < e.length;
       d++
       )
           A(e[d][1], e[d][0], this)
   ...
   for (b = []; (d = f++ * e) <= 100; ) b.push(d)
       a = "positions"
                ...
                : "values" === a
                ? c
                ? b.map((a) => ta.fromStepping(ta.getStep(ta.toStepping(a))))
                : b
                : void 0
        }
        function A(a, b, c) {
   ...
   return 0 === e.ort ? a.width || ha[b] : a.height || ha[b]
        ...
        function F(a, b, c, d) {
            ...
            : d.hover && b.buttons
            ? !1
            : (oa || b.preventDefault(), (b.calcPoint = b.points[e.ort]), void c(b, d))
            : !1,
   g = []
   return (
       a.split(" ").forEach((a) => {
            ...
            return (
                ...
                (d && b > 0 && (c = Math.max(c, a[b - 1] + e.margin)),
                 f && b < ia.length - 1 && (c = Math.min(c, a[b + 1] - e.margin))),
                    ...
                    e.padding &&
                    (0 === b && (c = Math.max(c, e.padding)), b === ia.length - 1 && (c = Math.min(c, 100 - e.padding))),
                    (c = ta.getStep(c)),
                    (c = i(c)),
                    c !== a[b] || g ? c : !1
            )
        ...
        function da() {
            return qa.map((a, b) => {
                var c = ta.getNearbySteps(a),
                          ...
                          (f =
                          d > c.thisStep.startValue ? c.thisStep.step : c.stepBefore.step === !1 ? !1 : d - c.stepBefore.highestStep),
