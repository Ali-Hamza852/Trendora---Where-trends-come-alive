...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery")
    ...
    +((a) => {
      ...
      (c.prototype.show = function (b) {
       ...
       ((this.isShown = !0),
        ...
        this.$dialog.on("mousedown.dismiss.bs.modal", () => {
            this.$element.one("mouseup.dismiss.bs.modal", (b) => {
                a(b.target).is(this.$element) && (this.ignoreBackdropClick = !0)
            })
        }),
        this.backdrop(() => {
            var e = a.support.transition && this.$element.hasClass("fade")
            this.$element.parent().length || this.$element.appendTo(this.$body),
                      this.$element.show().scrollTop(0),
                      this.adjustDialog(),
                      e && this.$element[0].offsetWidth,
                      ...
                      ? this.$dialog
                      .one("bsTransitionEnd", () => {
                          this.$element.trigger("focus").trigger(f)
                      })
                      .emulateTransitionEnd(c.TRANSITION_DURATION)
                      : this.$element.trigger("focus").trigger(f)
        }))
      ...
      (c.prototype.setScrollbar = function () {
          var a = Number.parseInt(this.$body.css("padding-right") || 0, 10)
    ...
    +((a) => {
      ...
      (c.prototype.getDefaults = () => c.DEFAULTS),
      ...
      (c.prototype.show = function () {
       ...
       var q = () => {
           var a = this.hoverState
           this.$element.trigger("shown.bs." + this.type), (this.hoverState = null), "out" == a && this.leave(this)
       }
      ...
      (c.prototype.applyPlacement = function (b, c) {
       ...
       e = d[0].offsetWidth,
       f = d[0].offsetHeight,
       g = Number.parseInt(d.css("margin-top"), 10),
       h = Number.parseInt(d.css("margin-left"), 10)
       isNaN(g) && (g = 0),
       isNaN(h) && (h = 0),
       (b.top += g),
       (b.left += h),
      ...
      (c.prototype.getCalculatedOffset = (a, b, c, d) =>
      "bottom" == a
